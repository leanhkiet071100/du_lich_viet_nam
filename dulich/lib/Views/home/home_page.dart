...
class _HomePageState extends State<HomePage> {
  ...
  List sdt = ['094 738 79 79', '0236 3658 999'];
  List diachi = [
    '149 Võ Thị Sáu, Phường 2, Thành phố Vũng Tầu',
    '10 An Thượng 36, Bắc Mỹ Phú, Ngũ Hành Sơn',
  ];
  List tinh = ['Bà Rịa - Vũng Tàu', 'Đà Nẵng'];
  List img = [
    'https://milanvungtauhotel.com/files/files/56.jpg',
    'https://ak-d.tripcdn.com/images/0225y12000ab88z3m475D_R_960_660_R5_D.jpg'
  ];
    ...
    return Scaffold(
      ...
      SliverList(
        delegate: SliverChildBuilderDelegate(
          ...
          childCount: 2, // Số lượng phần tử trong danh sách
        ),
      ),
    ]));
  }
