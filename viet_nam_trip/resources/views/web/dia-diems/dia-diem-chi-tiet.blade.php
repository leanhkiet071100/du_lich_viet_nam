                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
                            ...
                            <p class="rate mb-5">
                                <span class="loc"><a href="#"><i class="icon-map"></i>{{ $dia_diem->chi_tiet_dia_chi }}, {{ $dia_diem->xa }},{{ $dia_diem->huyen }}, {{ $dia_diem->tinh }}</a></span>
                                <span class="star">
                                    @for ($i = 0; $i < 5; $i++)
                                        @if ($i < $dia_diem->sao)
                                            <i class="icon-star"></i>
                                ...
                                @foreach ($ls_dia_diem_noi_bat as $key=>$value )
                                    <div class="col-md-4">
                                        <div class="destination">
                                            <a href="{{route('web.dia-diem.show',['id'=>$value->id])}}" class="img img-2"
